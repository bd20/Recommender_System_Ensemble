...
#define USER_NUM 10000  //10K:943 1M:6040
#define ITEM_NUM 10000 //10K:1682 1M:3900
#define K_NUM  100
//#define TRAINING_SET "../dataset/netflix/data_without_prob.txt"
#define TRAINING_SET "../dataset/tr_1_8_1.txt"
#define PROBE_SET "../dataset/va_1_1_1.txt"
...
int main(int argc, char ** argv)
{
    ...
    //for(int i=0; i < 10; i++)
    {
        //    beta = i*0.001 + 0.002;
        //    cout << beta << endl;
        svd::model(K_NUM,alpha1,alpha2,beta1,beta2,20,0.9);
    }
    end = time(NULL);
    duration = end-start;
